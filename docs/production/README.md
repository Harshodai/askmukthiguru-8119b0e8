...
| Retrieval correctness and multilingual probe | [`railway_retrieval_fix_evidence_2026-08-22.md`](railway_retrieval_fix_evidence_2026-08-22.md) | Combined Railway deployment, 83-test scoped suite, Hindi/Telugu metadata-only probes | Retrieval return regression fixed; multilingual quality and latency gates remain open |
