...
1. **Proprietary doctrine corpus** — Qdrant `spiritual_wisdom_contextual` collection: **12,904 points** (verified live 2026-09-13; the `spiritual_wisdom` collection this line originally cited no longer exists and the 89,053 figure was stale by ~7x — see `docs/research/RESEARCH_SYNTHESIS_2026-09-13.md` §0.1) from books, 450+ YouTube discourses, and lectures by Sri Preethaji, Sri Krishnaji, and Sri Amma Bhagavan (same lineage). This is licensed/curated first-party content, not scraped generic wisdom text — a competitor without a relationship to these teachers cannot legally or practically replicate the corpus.
