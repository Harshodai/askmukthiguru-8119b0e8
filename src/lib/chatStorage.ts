...
export type MessageErrorKind = 'network' | 'unauthorized' | 'rate_limited' | 'server_error' | 'timeout' | 'connection_refused' | 'dns_failure' | 'backend_down' | 'telemetry_failed' | 'unknown';
