      ...
      <div className="relative z-10 container mx-auto px-6">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="text-tejas">Meet Your</span>{' '}
          ...
          <div className="glass-card-hover p-8 md:p-12">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              ...
              <div className="flex-1 text-center md:text-left">
                <h3 className="text-2xl md:text-3xl font-bold text-tejas mb-2">
                  Sri Preethaji & Sri Krishnaji
                </h3>
                <p className="text-ojas-light font-medium mb-4">
                ...
                <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                  {['Beautiful State', 'Consciousness', 'Inner Peace', 'Oneness'].map((tag) => (
                    <span
                      key={tag}
                      className="px-3 py-1 rounded-full text-sm bg-ojas/10 text-ojas-light border border-ojas/20"
                    >
                      {tag}
                    </span>
                  ))}
            ...
            <div className="mt-8 pt-8 border-t border-border/50">
              <div className="flex items-start gap-4">
                ...
                <blockquote className="text-lg italic text-tejas/90">
        ...
        <motion.p
          ...
          className="text-center mt-8 text-sm text-muted-foreground/70"
        >
