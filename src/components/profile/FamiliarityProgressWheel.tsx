                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="text-muted-foreground hover:text-saffron-gold transition-colors p-2 min-w-[40px] min-h-[40px] inline-flex items-center justify-center"
                      title="Pronounce term"
                      aria-label={`Pronounce ${concept.transliteration}`}
                    >
