...
const isLovableProject = 
  rawUrl.includes('fynkjimvuimakgtidvuq') || 
  (typeof window !== 'undefined' && (
    window.location.hostname === 'askmukthiguru.lovable.app' ||
    window.location.hostname.endsWith('.lovableproject.com')
  ));

const SUPABASE_URL = isLovableProject
  ? 'https://ozmjeuqbholoxypfxixb.supabase.co'
  : (import.meta.env.VITE_SUPABASE_URL || 'http://localhost:54321');

const SUPABASE_PUBLISHABLE_KEY = isLovableProject
  ? 'sb_publishable_xiLP47LDiH7JKMf1GfLhng_6MZfd8JC'
