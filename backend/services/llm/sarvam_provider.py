"""Sarvam Cloud LLM Provider strategy implementation."""
...
class SarvamProvider(LLMProvider):
    """Adapter strategy wrapping SarvamCloudService to match the LLMProvider/LLMService contract."""
    ...
    async def check_faithfulness(self, *, answer: str, context: str, **kwargs: Any) -> dict[str, Any]:
        return await self._service.check_faithfulness(answer, context)
