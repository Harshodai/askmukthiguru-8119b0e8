...
def test_intent_classification_prompt_has_factual_educational_clause():
    ...
    assert (
        "educational questions about meditation" in INTENT_CLASSIFICATION_PROMPT
        or "How do I start meditating" in INTENT_CLASSIFICATION_PROMPT
...
def test_intent_classification_prompt_has_critical_distinction():
    ...
    assert (
        "CRITICAL" in INTENT_CLASSIFICATION_PROMPT or "DISTINCTION" in INTENT_CLASSIFICATION_PROMPT
...
def test_intent_classification_prompt_has_action_meditation_examples():
    ...
    assert (
        "Guide me through a meditation" in INTENT_CLASSIFICATION_PROMPT
        or "Let's do a meditation session" in INTENT_CLASSIFICATION_PROMPT
...
@pytest.mark.parametrize(
    "raw,expected_intent,expected_complexity",
    [
