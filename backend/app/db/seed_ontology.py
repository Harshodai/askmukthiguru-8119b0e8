...
def seed_spiritual_ontology():
    ...
    try:
        ...
        def _migrations(tx):
            ...
            tx.run(
                "CREATE CONSTRAINT UNIQUE_TEACHER_NAME IF NOT EXISTS FOR (t:Teacher) REQUIRE t.name IS UNIQUE"
            )
            tx.run(
                "CREATE CONSTRAINT UNIQUE_CONCEPT_NAME IF NOT EXISTS FOR (c:Concept) REQUIRE c.name IS UNIQUE"
            )
            tx.run(
                "CREATE CONSTRAINT UNIQUE_PRACTICE_NAME IF NOT EXISTS FOR (p:Practice) REQUIRE p.name IS UNIQUE"
            )
        ...
        def _seed(tx):
            ...
            concepts = [
                ...
                (
                    "Karma",
                    "Action, work, or deed; the spiritual principle of cause and effect where every action creates consequences.",
                ),
                (
                    "Dharma",
                    "Righteous conduct, moral duty, or the natural order of life that upholds cosmic harmony.",
                ),
                (
                    "Consciousness",
                    "The fundamental state of awareness and being that underlies all existence.",
                ),
                (
                    "Moksha",
                    "Liberation from the cycle of suffering; the state of oneness with universal intelligence.",
                ),
                # Mukthi Guru core framework
                (
                    "Beautiful State",
                    "A state of connection, peace, and inner joy, free from suffering. Sri Preethaji teaches this is the only alternative to the stress state.",
                ),
                (
                    "Suffering State",
                    "A contracted state of division, fear, and obsessive self-centric thinking. The default human condition when not in the beautiful state.",
                ),
                (
                    "Suffering",
                    "A contracted state of division, fear, and ego-centric existence arising from obsessive self-centric thinking.",
                ),
                (
                    "Universal Intelligence",
                    "The divine field or cosmic consciousness that becomes accessible when one approaches with passion, stillness, and dedication.",
                ),
                (
                    "Inner Stillness",
                    "The foundational state of calm and presence that allows universal intelligence to flow. Prerequisite for spiritual awakening.",
                ),
                (
                    "Self-Centric Thinking",
                    "Obsessive, incessant preoccupation with oneself — the root cause of all emotional suffering, war, conflict, and division.",
                ),
                # The Warring Self — three expressions
                (
                    "Warring Self",
                    "The divided self that perpetually creates suffering through three expressions: shrinking, destructive, and inert.",
                ),
                (
                    "Shrinking Self",
                    "An expression of the warring self characterized by comparison, inadequacy, and low self-esteem.",
                ),
                (
                    "Destructive Self",
                    "An expression of the warring self characterized by anger, blame, aggression, and perfectionism.",
                ),
                (
                    "Inert Self",
                    "An expression of the warring self characterized by laziness, procrastination, and giving up.",
                ),
                # Deeksha / Oneness Blessing
                (
                    "Deeksha",
                    "The Oneness Blessing — a sacred energy transmission from guru to seeker that facilitates spiritual awakening and clears karmic blocks.",
                ),
                (
                    "Ekam",
                    "The World Centre for Enlightenment founded by Sri Preethaji and Sri Krishnaji, dedicated to shifting human consciousness from division to oneness.",
                ),
                (
                    "Oneness",
                    "The state of unity consciousness where the sense of separation dissolves. Also called non-duality or advaita.",
                ),
                # The Four Sacred Secrets
                (
                    "Four Sacred Secrets",
                    "Four transformative teachings revealed by Sri Preethaji and Sri Krishnaji: Live with a Spiritual Vision, The Science of Purification, See the Truth of Suffering, Dissolve into the Beautiful State.",
                ),
                (
                    "Spiritual Vision",
                    "The first sacred secret — living with a vision beyond material life, seeing the divine purpose in all experiences.",
                ),
                (
                    "Science of Purification",
                    "The second sacred secret — the process of purifying the mind and heart through awareness and practice.",
                ),
                (
                    "Truth of Suffering",
                    "The third sacred secret — seeing clearly that all suffering arises from self-centric thinking and the warring self.",
                ),
                (
                    "Dissolving into the Beautiful State",
                    "The fourth sacred secret — complete surrender into the state of connection, peace, and inner joy.",
                ),
                # Heart / Awakening
                (
                    "Heart Awakening",
                    "The shift from living in the mind (thought, analysis, self-centric thinking) to living in the heart (feeling, connection, intuition).",
                ),
                (
                    "Heart Explosion",
                    "A sudden, profound opening of the heart center experienced in deep meditation or through the grace of the guru. Gateway to manifesting divine blessings.",
                ),
                (
                    "Compassion",
                    "The natural state of the awakened heart — feeling deeply connected to others, transcending the sense of separation.",
                ),
                (
                    "Intuition",
                    "Heart-based knowing that transcends intellectual analysis. Awakened when one enters the beautiful state.",
                ),
                # Spiritual Processes
                (
                    "Awakening",
                    "The shift from the suffering state to the beautiful state. A gradual or sudden realization of one's true nature beyond the warring self.",
                ),
                (
                    "Grace",
                    "Divine assistance that flows when one surrenders the ego and opens to universal intelligence.",
                ),
                (
                    "Surrender",
                    "The conscious letting go of control, resistance, and self-centric thinking. The gateway to grace and transformation.",
                ),
                (
                    "Presence",
                    "Being fully in the present moment, free from regrets about the past and anxiety about the future.",
                ),
                (
                    "Inner Truth",
                    "The truth that reveals itself through inner stillness and presence, beyond what the mind can conceptualize.",
                ),
                (
                    "Collective Meditation",
                    "Group spiritual practice in which the shared intention and consciousness amplify individual practice, creating a powerful field of transformation.",
                ),
                # Manifestation & Life
                (
                    "Divine Manifest",
                    "The aspect of the divine that takes form — the universe, nature, and all creation as an expression of universal intelligence.",
                ),
                (
                    "Divine Unmanifest",
                    "The formless, transcendent aspect of the divine — pure consciousness beyond all attributes and forms.",
                ),
                (
                    "Synchronicity",
                    "Meaningful coincidences that arise when one is aligned with universal intelligence. A sign of being in the beautiful state.",
                ),
                (
                    "Prosperity",
                    "Natural flow of abundance that arises when one lives from the beautiful state. Includes material, emotional, and spiritual well-being.",
                ),
                (
                    "Karmic Clearing",
                    "The process of releasing accumulated karmic debt through awakening, awareness, and breaking free from the thinking that created the karma in the first place.",
                ),
                # Practices & Tools
                (
                    "Soul Sync",
                    "A practice designed to shift the seeker into a state of oneness through synchronized breath and awareness.",
                ),
                (
                    "Serene Mind",
                ...
                (
                    "Three Questions",
                    "A framework for self-inquiry: What is my state? What time is it (past/present/future)? Who am I beyond the warring self?",
                ),
                (
                    "Serene Mind Flame",
                    "A flame visualized at the eyebrow center during the Serene Mind practice, representing the light of consciousness.",
                ),
            ]
            ...
            practices = [
                (
                    "Meditation",
                    "General practice of quiet observation and mindfulness. The foundation of all spiritual practice.",
                ),
                (
                    "Yoga",
                    "Physical and mental disciplines aligning body and mind, preparing the practitioner for deeper spiritual experience.",
                ),
                (
                    "Serene Mind",
                ...
                (
                    "Soul Sync",
                    "A practice designed to shift the seeker into a state of oneness through synchronized breath and heart-centered awareness.",
                ),
                (
                    "Three Question Meditation",
                    "A self-inquiry meditation asking: What is my state? What time is it? Who am I? Designed to return the practitioner to the beautiful state.",
                ),
                (
                    "Inner Stillness Practice",
                    "The foundational practice of sitting in quiet presence, allowing universal intelligence to flow through the still mind.",
                ),
                (
                    "Collective Meditation Practice",
                    "Group meditation where shared intention and collective consciousness amplify the transformative power of individual practice.",
                ),
                (
                    "Kriya Practice",
                    "Sacred spiritual actions and purificatory practices that accelerate inner transformation and karmic clearing.",
                ),
                (
                    "Heart Awakening Practice",
                    "A practice focused on opening the heart center, moving awareness from the thinking mind to the feeling heart.",
                ),
                (
                    "Four Sacred Secrets Practice",
                    "Working systematically with the four sacred secrets as a complete spiritual framework for transformation.",
                ),
            ]
