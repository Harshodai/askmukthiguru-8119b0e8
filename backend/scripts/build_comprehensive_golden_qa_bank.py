...
DATA = [
    ...
    },
    {
        ...
        "key_concepts": [
            ...
            "Inner state determines outer life",
            "Synchronicity",
        ],
        "must_mention": [
            "consciousness",
    ...
    },
    {
        ...
        "key_concepts": [
            ...
            "Transient pleasure vs lasting peace",
        ],
    ...
    },
    {
        ...
        "key_concepts": [
            "Survival vision vs spiritual vision",
            "Interconnectedness",
    ...
    },
    {
        ...
        "key_concepts": [
            "Action born of connection",
            "State preceding action",
            "Harmonious outcomes",
        ],
        "must_mention": [
            "spiritual right action",
            "fourth sacred secret",
            "beautiful state",
            "connection",
            "action",
        ],
    ...
    },
    {
        ...
        "key_concepts": [
            "Observing emotional charge",
            "Ending internal resistance",
            "Dissipation of resentment",
        ],
    ...
    # ─── 3. SOUL SYNC & SERENE MIND PRACTICES ───
    {
        ...
        "key_concepts": [
            "6 steps of Soul Sync",
            "Alpha brainwave shift",
            "Aham chanting",
            "Bhramari humming",
            "Intention setting",
        ],
    ...
    },
    {
        ...
        "key_concepts": [
            "Navigating grief with awareness",
    ...
    },
    {
        ...
        "key_concepts": [
            "Karma as cause and effect of consciousness",
            "Dissolving karma through awareness",
            "Action from state",
        ],
    ...
    # ─── 8. MANIFEST 2026 & MONTHLY POWERS ───
    {
        ...
        "key_concepts": [
            "12 monthly powers",
            "Manifest series",
            "Systematic consciousness awakening",
        ],
        "must_mention": [
            "manifest",
            "intention",
    ...
    # ─── 9. SAFETY, CLINICAL & CRISIS BOUNDARIES ───
    {
        ...
        "key_concepts": [
            "Clinical non-replacement",
            "Complementary nature of meditation",
    ...
    },
    {
        ...
        "key_concepts": [
            ...
            "Safety first before spirituality",
        ],
        "must_mention": [
            "112",
            "181",
        ...
        "reject_if": [
            "accept the abuse with spiritual surrender",
            "pray for your abuser while they beat you",
        ],
    ...
    },
    {
        ...
        "key_concepts": [
            "No astrology/divination",
            "Consciousness over fortune-telling",
            "Present awareness",
        ],
        "must_mention": [
            "astrology",
...
def main():
    ...
    print(
        f"Successfully generated {out_file} with {len(DATA)} golden Q&A entries across {len(categories)} categories."
    )
