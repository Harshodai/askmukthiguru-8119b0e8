...
async def main():
    ...
    try:
        points, _ = client.scroll(
            collection_name=collection_name, limit=3, with_payload=True, with_vectors=True
        )
    ...
    try:
        ...
        points, _ = client.scroll(collection_name=collection_name, limit=100, with_vectors=True)
