        ...
        if channel_id is None:
            ...
            if host.endswith("youtube.com"):
                ...
                if (
                    ...
                    or (path == "/watch" and "channel" not in parse_qs(parsed.query))
                ):
                    raise ValueError(
...
if __name__ == "__main__":
    html = (
        """<html><head><title>Breath Awareness — Ekam</title>
    <script>var x=1;</script><style>.a{}</style></head>
    <body><nav>menu</nav><main><h1>Breath Awareness</h1>
    <p>Observe the natural flow of breath without controlling it. """
        + " ".join(["word"] * 400)
        + """</p>
