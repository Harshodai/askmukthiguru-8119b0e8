...
def build_gu_data():
    ...
    gu["privacy"] = {
        ...
        "storeChats": "ચેટ વાતચીતો અને સંદેશાઓ — chatStorage દ્વારા તમારા ઉપકરણ પર સ્થાનિક રીતે સંગ્રહિત થાય છે, જ્યારે બેકએન્ડ ઇન્ફરન્સ લૉગ્સ ચેટ સામગ્રી અને સંબંધિત ઓળખકર્તાઓને જાળવી શકે છે.",
    ...
    gu["terms"] = {
        ...
        "notMedicalText": "પ્રતિસાદો AI દ્વારા જનરેટ કરવામાં આવે છે અને તે વ્યાવસાયિક માનસિક સ્વાસ્થ્ય સંભાળનો વિકલ્પ નથી. જો તમે કટોકટીમાં હોવ, તો કૃપા કરીને કોઈ લાયક વ્યાવસાયિક અથવા ક્રાઇસિસ હેલ્પલાઇનનો તરત જ સંપર્ક કરો. ભારત: iCall +91-9152987821, Vandrevala Foundation +91 9999 666 555.",
