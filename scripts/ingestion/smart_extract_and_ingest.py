...
from pageindex.utils import (
    ...
    llm_acompletion, llm_completion, JsonLogger
)
...
KNOWN_STRUCTURES = {
    "The_Four_Sacred_Secrets.pdf": [
        ...
        # Part I
        {"structure": "3",   "title": "The First Sacred Secret: Live with a Spiritual Vision",   "start": 15,  "end": 29,  "level": 0},
        {"structure": "3.1", "title": "The First Sacred Secret — By Krishnaji",             "start": 15,  "end": 16,  "level": 1},
        {"structure": "3.2", "title": "The First Sacred Secret — By Preethaji",             "start": 17,  "end": 25,  "level": 1},
        {"structure": "3.3", "title": "Soul Sync Meditation Practice",                      "start": 26,  "end": 29,  "level": 1},
        {"structure": "4",   "title": "The First Life Journey: Heal the Wounded Child",     "start": 30,  "end": 44,  "level": 0},
        # Part II
        {"structure": "5",   "title": "The Second Sacred Secret: Discover Your Inner Truth", "start": 46,  "end": 57,  "level": 0},
        {"structure": "6",   "title": "The Second Life Journey: Dissolve the Inner Divide", "start": 58,  "end": 74,  "level": 0},
        {"structure": "6.1", "title": "Why Am I Unhappy?",                                  "start": 60,  "end": 73,  "level": 1},
        {"structure": "6.2", "title": "Soul Sync Exercise: Transforming from a Warring Self to a Beautiful Self", "start": 74, "end": 74, "level": 1},
        # Part III
        {"structure": "7",   "title": "The Third Sacred Secret: Awaken to Universal Intelligence", "start": 76, "end": 84, "level": 0},
        {"structure": "8",   "title": "The Third Life Journey: Become a Heartful Partner",  "start": 85,  "end": 108, "level": 0},
        {"structure": "8.1", "title": "What Is Connection?",                                "start": 86,  "end": 90,  "level": 1},
        {"structure": "8.2", "title": "What Are We Seeking?",                               "start": 91,  "end": 91,  "level": 1},
        {"structure": "8.3", "title": "The Two Foundations",                                "start": 92,  "end": 93,  "level": 1},
        {"structure": "8.4", "title": "The Shadow of Hurt",                                 "start": 94,  "end": 96,  "level": 1},
        {"structure": "8.5", "title": "Stages of Disconnection",                            "start": 97,  "end": 108, "level": 1},
        # Part IV
        {"structure": "9",   "title": "The Fourth Sacred Secret: Practice Spiritual Right Action", "start": 110, "end": 116, "level": 0},
        {"structure": "10",  "title": "The Fourth Life Journey: Emerge into a Conscious Wealth Creator", "start": 117, "end": 140, "level": 0},
        {"structure": "10.1","title": "Pursuing Life's Purpose from a Beautiful State of Connection", "start": 132, "end": 140, "level": 1},
        # Back matter
        {"structure": "11",  "title": "Epilogue: Questions and Answers about Our Academy",  "start": 141, "end": 154, "level": 0},
        {"structure": "12",  "title": "About the Authors",                                  "start": 155, "end": 157, "level": 0},
        {"structure": "13",  "title": "Notes and References",                               "start": 158, "end": 161, "level": 0},
    ],
}
...
HEADING_PATTERNS = [
    ...
    re.compile(r'^(Epilogue|Introduction|Prologue|Foreword|Preface|Acknowledgments|Appendix|Conclusion)\b', re.IGNORECASE),
...
def detect_sections_programmatic(pages):
    ...
    if not sections:
        sections = [{'title': 'Full Document', 'start': 1, 'end': len(pages), 'level': 0, 'structure': '1'}]
...
def verify_structure(tree, pages):
    ...
    def _check(node):
        ...
        skip_words = {'the', 'a', 'an', 'of', 'to', 'and', 'in', 'from', 'by', 'into', 'about', 'our', '—', 'is'}
        title_words = [w.strip('.,!?:;()') for w in title.lower().split() if len(w) > 2 and w.lower() not in skip_words]
...
async def async_main(args):
    ...
    def print_tree(nodes, indent=0):
        for node in nodes:
            ...
            print(f"{'  ' * indent}[{node.get('node_id', '?')}] {node['title']} ({pages_str}){summary_preview}")
            if 'nodes' in node:
...
def main():
    ...
    parser.add_argument('--model', type=str, default=None, help='LLM model for summaries (e.g. ollama/deepseek-r1:7b)')
