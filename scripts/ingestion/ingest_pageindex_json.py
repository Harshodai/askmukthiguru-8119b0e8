...
def extract_nodes_from_pageindex(tree, current_level=1, cluster_id=None):
    ...
    for node in tree:
        ...
        if not children:
            ...
            if summary or text:
                summary_content = summary if summary else text[:1000] # Use text as fallback summary
            ...
            child_summaries, child_leaves = extract_nodes_from_pageindex(children, current_level=0, cluster_id=current_cluster_id)
