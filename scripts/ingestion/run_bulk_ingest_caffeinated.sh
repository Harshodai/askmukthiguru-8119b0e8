...
echo "================================================================"
echo "☕ LAUNCHING CAFFEINATED & NOHUP INGESTION PIPELINE"
echo "   Model        : qwen2.5:1.5b (Ollama Metal GPU)"
...
nohup caffeinate -dimsu "${REPO_ROOT}/scripts/ingestion/supervisor.sh" "${WORKERS}" >> "${LOG_FILE}" 2>&1 &
