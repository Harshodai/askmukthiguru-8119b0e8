#!/usr/bin/env python3
"""
Evaluate OpenRouter Cheap Models for AskMukthiGuru.
Runs the query: "I want to experience deeper inner peace. What teachings or practices do you suggest?"
across multiple cheap OpenRouter models and measures score via PersonaDiscriminator.
"""
...
logger = logging.getLogger("eval_openrouter")
...
async def run_evaluation():
    ...
    logger.info("Starting OpenRouter Model Evaluation...")
    ...
    print("\n" + "=" * 80)
    print(" 🏆 OPENROUTER MODEL BENCHMARK RESULTS")
    print("=" * 80)
    for r in results:
