...
def rectify_isolated_nodes():
    ...
    try:
        ...
        with driver.session() as session:
            ...
            result = session.run("MATCH (n) WHERE n.entity_id IS NULL OR n.entity_id = '' RETURN count(n) as malformed_count")
            ...
            if malformed_count > 0:
                ...
                session.run("MATCH (n) WHERE n.entity_id IS NULL OR n.entity_id = '' DETACH DELETE n")
