...
- Skips `resolve_followup`, `decompose_query`, `navigate_and_hyde`, `rerank_documents`, `grade_documents`, `context_engineer`, `agentic_graph_traversal`, `cross_teacher_reasoning`
